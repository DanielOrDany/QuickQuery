                                ...
                                <div className={'table-name'}>
                                  {
                                    table.alias.match(engRE) ?
                                        <span id="table-n">{table.alias}</span>
                                        :
                                        <span id="table-n"> {
              ...
              !window.location.hash.includes("create-table") && (
                  <div className="empty-result-row">
                    ...
                    <div className="empty-result-column">
                      ...
                      <button className='empty-right-side-tables-page-btn' onClick={() => this.createTable()}>Create table</button>
