...
class Menu extends React.Component {
  ...
  componentDidMount() {
    ...
    if (
      !(window.location.hash === "" || window.location.hash === "#connections")
    ) {
            ...
            <div className="sharing-buttons">
              <div id="import-div">
                <input
                  id="import-button"
                  type="file"
                  onChange={event => this.importConfig(event)}
                />
                <p>Import settings from file</p>
              </div>
              <div id="export-div">
                <span id="export-button" onClick={() => this.share()}>
                  Export
                </span>
