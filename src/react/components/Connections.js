...
import DatabaseMiniMenuPopup from "../popups/DatabaseMiniMenuPopup";
...
export default class Connections extends React.Component {
    ...
    isDBMiniMenuOpen = () => {
        this.setState({
            isDBMiniMenu: !this.state.isDBMiniMenu,
        })
    }
                                            ...
                                            return (
                                                <div className={'database'} id={conn.name} key={conn.name}
                                                    ...
                                                    <DatabaseMiniMenuPopup
                                                        isOpen={this.state.isDBMiniMenu}
                                                    >
                                                    </DatabaseMiniMenuPopup>
